...
namespace projection_kernels
{
    ...
    template <int THREADS>
    __global__ void batched_gate_up_swiglu_kernel(
        float *, const float *, const bf16_t *, const bf16_t *, int, int);
    template <int THREADS>
...
namespace attention_kernels
{
    ...
    __global__ void q_absorb_rope_kernel(
        ...
        int, const float *, int);
    template <int THREADS>
    __global__ void batched_q_absorb_rope_kernel(
        float *, float *, const float *, const bf16_t *, int, int, int, int, int,
        int, const float *, int);
    template <int THREADS>
    ...
    template <int THREADS>
    __global__ void batched_value_up_kernel(
        float *, const float *, const bf16_t *, int, int, int, size_t);
    template <int THREADS>
    ...
    template <int THREADS>
    __global__ void batched_kv_norm_rope_rows_kernel(
        float *, const float *, const bf16_t *, int, int, int, int,
        const float *, int, float);
    template <int THREADS>
    __global__ void fused_prefill_mla_kernel(
        float *, const float *, const float *, const float *, int, int, int, int,
        int, float);
}
...
namespace moe_kernels
{
    ...
    __global__ void router_topk_wave64_kernel(
        float *, const float *, int *, float *, int, int, int, int, int, float);
    template <int THREADS>
    __global__ void moe_token_sort_kernel(
        const int *, int, int, int *);
    template <int THREADS>
    __global__ void expert_prefix_sum_kernel(
        int *, const int *, int);
    template <int THREADS>
    __global__ void moe_token_scatter_kernel(
        const int *, int, int, int *, int *, int *, int *);
    template <int THREADS>
    __global__ void batched_sorted_routed_gate_up_kernel(
        float *, const float *, const char *, const size_t *, const size_t *,
        const int *, const int *, const int *, int, int, int, int);
    template <int THREADS>
    __global__ void batched_sorted_routed_down_kernel(
        float *, const float *, const char *, const size_t *, const int *,
        const int *, const int *, const float *, int, int, int, int);
    template <int THREADS>
    __global__ void batched_shared_gate_up_kernel(
        float *, const float *, const bf16_t *, const bf16_t *, int, int, int);
    template <int THREADS>
    __global__ void batched_shared_down_kernel(
        float *, const float *, const bf16_t *, int, int, int);
    template <int THREADS>
